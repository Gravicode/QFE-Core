...
namespace QFE.WPF.Tools
{
    ...
    public class CSVReader : IDisposable
    {
        ...
        public static System.Data.DataTable OpenCSV(String FileName)
        {
            int Counter = 0;
            RowCount = 0;
            System.Data.DataTable tb = new System.Data.DataTable("CSV Table Editor");
            ...
            using (CSVReader csv = new CSVReader(FileName))
            {
                ...
                while ((fields = csv.GetCSVLine()) != null)
                {
                    ...
                    {
                        String[] DataField = new String[tb.Columns.Count];
                        //Console.WriteLine("New CSV line begins");
                        int Cacah = 0;
                        foreach (string field in fields)
                        {
                            DataField[Cacah] = field;
                            Cacah++;
                        }
                        tb.Rows.Add(DataField);
                    }
                    Counter++;
                }
            }
        ...
        public static System.Data.DataTable OpenCSV(String FileName, int RecordCount)
        {
            int Counter = 0;
            RowCount = 0;
            ...
            using (CSVReader csv = new CSVReader(FileName))
            {
                ...
                while ((fields = csv.GetCSVLine()) != null)
                {
                    ...
                    Counter++;
                    if (Counter - 1 > RecordCount) break;
                }
            }
            RowCount = Counter - 1;
            return tb;
